...
def resultyy():
    if request.method == 'POST':
        ...
        gender = request.form['gender']
        age = request.form['age']
        mdvp_fo_hz= request.form['mdvp_fo_hz']
        mdvp_fhi_hz = request.form['mdvp_fhi_hz']
        mdvp_flo_hz= request.form['mdvp_flo_hz']
        mdvp_jitter= request.form['mdvp_jitter']
        mdvp_jitter_abs = request.form['mdvp_jitter_abs']
        ...
        mdvp_apq= request.form['mdvp_apq']
